                            ...
                            <div className="popular-carousel-header">
                                ...
                                <div className="popular-carousel-header-nav">
                                    ...
                                    className="popular-carousel-header-nav-prev">                                        
                                        ...
                                        className="svg-inline--fa fa-chevron-left fa-w-10" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    ...
                                    className="popular-carousel-header-nav-next">
                                        ...
                                        className="svg-inline--fa fa-chevron-right fa-w-10" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                            <path fill="currentColor"
                                ...
                                <div className="popular-carousel-body-controls">
                                    <div className="popular-carousel-body-controls-tabs">
                                        ...
                                        <a href="#" className="popular-carousel-body-controls-showmore">
                                            ...
                                            className="svg-inline--fa fa-long-arrow-alt-right fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <path fill="currentColor"
